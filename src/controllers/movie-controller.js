...
//     this._filmDetailsComponent.setOnWatchedButtonClick((evt) => {
//       evt.preventDefault();
//       this._onWatchedButtonClick(film);
//     });

//     this._filmDetailsComponent.setOnWatchlistButtonClick((evt) => {
//       evt.preventDefault();
//       this._onWatchlistButtonClick(film);
//     });

//     this._filmDetailsComponent.setOnFavoritesButtonClick((evt) => {
//       evt.preventDefault();
//       this._onFavoritesButtonClick(film);
//     });
